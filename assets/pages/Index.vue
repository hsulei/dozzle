        ...
        <div class="container">
          <div class="columns">
            ...
            <div class="column is-narrow" v-if="secured">
              <a class="button is-primary is-small" :href="`${base}/logout`">登出</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="column is-4">
        <div class="panel">
          ...
          <p class="panel-tabs" v-if="!search">
            <a :class="{ 'is-active': sort === 'running' }" @click="sort = 'running'">运行中</a>
            <a :class="{ 'is-active': sort === 'all' }" @click="sort = 'all'">全部</a>
          </p>
          <router-link
